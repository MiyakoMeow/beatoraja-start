...
## [Unreleased]
## [0.2.5](https://github.com/MiyakoMeow/beatoraja-start/compare/v0.2.4...v0.2.5) - 2026-05-06


### Bug Fixes

- remove unsupported -XX:+UseTransparentHugePages ([#33](https://github.com/MiyakoMeow/beatoraja-start/pull/33))
- reorder CHANGELOG for release-plz compatibility ([#31](https://github.com/MiyakoMeow/beatoraja-start/pull/31))
